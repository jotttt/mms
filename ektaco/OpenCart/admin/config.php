...
define('DB_PASSWORD', 'opencartuser@');
...
//CompuCash
define('CC5API_URL', 'https://www.compucash5.com/ccApi/');
define('IDENTITYSERVER_URL', 'https://www.compucash5.com/IdentityServer/connect/token');
define('CLIENT_ID', 'lennusadam');
define('SECRET', '5UQAWreP&sep');
