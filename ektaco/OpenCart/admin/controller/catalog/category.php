...
class ControllerCatalogCategory extends Controller {
	...
	protected function getList() {
		...
		$data['repair'] = $this->url->link('catalog/category/repair', 'token=' . $this->session->data['token'] . $url, true);
                ...
                /*CompuCash*/
		//$data['import_cc_categories'] = $this->url->link('common/compucash/importCCCategories', 'token=' . $this->session->data['token'] . $url, true);
		$data['import_cc_categories'] = $this->url->link('catalog/category/importCCCategories', 'token=' . $this->session->data['token'] . $url, true);
	...
	public function autocomplete() {
                ...
                if (count($productGroups->data) > 0)
		{
	   	...
	   	$this->session->data['success'] = 'Categories Successfully Imported!'; //success message
		$url = '';
		...
		protected function getIdentityToken()
		{
			...
			//curl_setopt($ch, CURLOPT_POSTFIELDS, 'grant_type=client_credentials&client_id=' . $clientId . '&scope=cc5api&client_secret=' . $secret);
		...
		protected function getProductGroups($idtoken)
		{
		    ...
		    /*Compucash update external product group*/
			...
			ob_end_clean();
                ...
                /*Compucash Product Group Id mapping*/
